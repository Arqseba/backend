      ...
      <div class="col-md-7 col-sm-6 single p-3">
        <div class="product">
          ...
          <div class="text" >
            ...
            <p>Quebradas de Manantiales cuenta con lotes de 250 m2, aptos dúplex, vigilancia 24 hs, todo rodeado de la naturaleza y el aire puro que caracteriza a Manantiales. Ideal para comenzar y disfrutar una vida en familia.</p>
